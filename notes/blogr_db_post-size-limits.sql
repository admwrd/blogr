...
-- Started on 2017-10-27 03:05:36
...
--
-- TOC entry 2798 (class 0 OID 16471)
-- Dependencies: 198
-- Data for Name: articles; Type: TABLE DATA; Schema: public; Owner: postgres
--

INSERT INTO articles (aid, title, posted, body, tags, description, tag) VALUES (5, 'I submitted this', '2017-10-20 17:15:02.170895', 'This is some text I came up with for this submitted article.', 'blah, foo, bar', NULL, NULL);
INSERT INTO articles (aid, title, posted, body, tags, description, tag) VALUES (6, 'this is an admin article', '2017-10-20 17:33:39.989516', 'This article was submitted by an admin', 'admin, cool, awesome ness', NULL, NULL);
INSERT INTO articles (aid, title, posted, body, tags, description, tag) VALUES (2, 'my insert title', '2017-10-20 13:45:00', 'this is a body', 'these are tags', NULL, '{"awesome ness",cool,article}');
INSERT INTO articles (aid, title, posted, body, tags, description, tag) VALUES (1, 'An Awesome Article', '2017-10-19 14:00:00', 'This is the contents of a very very awesome article.', 'Awesome, Article, Stuff', NULL, '{"awesome ness"," cool",article,admin}');
INSERT INTO articles (aid, title, posted, body, tags, description, tag) VALUES (4, 'I+submitted+this', '2017-10-20 13:57:50.204625', 'This+is+some+text+I+came+up+with+for+this+submitted+article.', 'blah%2C+foo%2C+bar', NULL, '{article,admin}');
INSERT INTO articles (aid, title, posted, body, tags, description, tag) VALUES (3, 'I+submitted+this', '2017-10-20 13:55:06.81759', 'This+is+some+text+I+came+up+with+for+this+submitted+article.', 'blah%2C+foo%2C+bar', NULL, '{awesome,cool,admin}');
INSERT INTO articles (aid, title, posted, body, tags, description, tag) VALUES (9, 'Descriptive Article', '2017-10-23 16:37:48.479308', 'Maecenas vitae libero sit amet nisl blandit molestie eget et eros. Quisque turpis erat, convallis ac vulputate ut, placerat quis mi. Quisque ut laoreet magna. Nullam nec dolor ultrices, cursus diam et, dictum dui. Maecenas porta ipsum mi, quis placerat mi molestie nec. Integer id pretium orci. Pellentesque sit amet enim pulvinar, eleifend ligula sed, pulvinar velit. Nam vitae magna gravida, egestas arcu eu, tempor lorem. Nulla lacinia lobortis libero, convallis laoreet tellus.
...
-- Completed on 2017-10-27 03:05:38
