...
-- DROP TRIGGER trigger_blog_users_update2 ON users;
 
CREATE TRIGGER trigger_blog_users_update BEFORE UPDATE OF hash_salt ON users FOR EACH ROW EXECUTE PROCEDURE proc_blog_users_update()
