...
//          
//          
//      maybe add a Template in the ContentContextLock because the Template can be used without a Responder directly
...
pub struct ContentRequest<'c, 'p, 'u> {
    ...
    // pub contexts: &'c ContentContextLock,
    pub route: &'u str,
...
impl ContentContextLock {
    pub fn load(dir: &str) -> ContentContextLock {
        unimplemented!()
    }
...
impl<'a, 'c, 'p, 'u> Responder<'a> for ContentRequest<'c, 'p, 'u> {
    fn respond_to(self, req: &Request) -> response::Result<'a> {
        ...
        if let Some(entry) = cache_entry {
            ...
            express // do not use express.compress(encoding) as the contents are already compressed!!!
            ...
            xresp.set_streamed_body( Cursor::new(output_contents) );
            xresp
        }
