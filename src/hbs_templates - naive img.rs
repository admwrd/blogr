...
pub enum TemplateBody {
    ...
    Article(Article, Option<String>, Option<String>), // article and optional message
...
impl TemplateArticle {
    pub fn new(content: Article, img: Option<String>, msg: Option<String>, info: TemplateInfo) -> TemplateArticle {
        TemplateArticle {
            body: content.to_display(),
            img: if let Some(image) = img { image } else { String::new() },
            msg: if let Some(m) = msg { m } else { String::new() },
            info,
        }
    }
...
pub fn hbs_template(content: TemplateBody, title: Option<String>, page: String, admin_opt: Option<AdministratorCookie>, user_opt: Option<UserCookie>, javascript: Option<String>, gen: Option<Instant>) -> Template {
    ...
    match content {
        ...
        TemplateBody::Article(article, img, msg) => {
            let context = TemplateArticle::new(article, img, msg, info);
